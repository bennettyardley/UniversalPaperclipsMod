...
if (marketModFlag == 0){
            ...
            document.getElementById("marketModDiv").style.display="none";
            } else {
            document.getElementById("marketModDiv").style.display="";      
            } 
    
if (funds<marketModCost){document.getElementById("btnMakeMarketMod").disabled = true;
            } else {
            document.getElementById("btnMakeMarketMod").disabled = false;    
            } 
...
function makeMarketMod(){  
    if(funds >= marketModCost){
        marketModLevel = marketModLevel + 1;
        funds = funds - marketModCost;
        document.getElementById('marketModLevel').innerHTML = marketModLevel;
        document.geftElementById('funds').innerHTML = funds.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
    }
    
    marketModCost = (Math.pow(1.14,marketModLevel)*1000);
    document.getElementById('marketModCost').innerHTML = marketModCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
...
for(var i=0; i < activeProjects.length; i++){
    ...
    var saveGame = {
        ...
        marketModFlag: marketModFlag,
        marketModCost: marketModCost,
        marketModLevel: marketModLevel,
...
function load() {
    ...
    for(var i=1; i<allStrats.length; i++){
        ...
        marketModFlag = loadGame.marketModFlag;
        marketModCost = loadGame.marketModCost;
        marketModLevel = loadGame.marketModLevel;
