...
var project220 = {
    id: "projectButton220",
    title: "Stock Market Improvement",
    priceTag: "(24,000 ops)",
    description: "Improve Stock Market Gain Percentages",
    trigger: function(){return investmentEngineFlag = 1},
    uses: 1,
    cost: function(){return operations>=24000},
    flag: 0,
    effect: function(){
        marketModFlag = 1;
        project220.flag = 1;
        displayMessage("Stock Market Upgrade Enabled");
        standardOps = standardOps - 24000;
        var element = document.getElementById("projectButton220");
        element.parentNode.removeChild(element);
        var index = activeProjects.indexOf(project220);
        activeProjects.splice(index, 1);
    }
}

projects.push(project220);